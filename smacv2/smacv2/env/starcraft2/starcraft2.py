...
class StarCraft2Env(MultiAgentEnv):
    ...
    def step(self, actions):
        ...
        terminated = False
        reward, hurt_r, kill_r, survive_r = self.reward_battle()
        ...
        if self.reward_scale:
            ...
            hurt_r /= self.max_reward / self.reward_scale_rate
            win_r /= self.max_reward / self.reward_scale_rate
            kill_r /= self.max_reward / self.reward_scale_rate
            survive_r /= self.max_reward / self.reward_scale_rate

        self.reward = reward

        return [reward, hurt_r, kill_r, survive_r, win_r], terminated, info
    ...
    def reward_battle(self):
        ...
        return reward, delta_enemy, delta_deaths, -delta_ally
